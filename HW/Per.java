//This program takes the name aand percentage of a student from the user and prints the grade of the students
//It also prints the Name of the student and Percentage obtained
class Per
{
    ...
    void Display_grades()
    {
        ...
        if(per>=90 && per<=100)//This will print the grade according to the percentage
        {
